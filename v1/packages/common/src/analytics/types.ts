export enum PostHogAction {
  ...
  SettingsNetworkMidgardClick = 'settings | network | midgard | click',
  ...
  UserWalletProfileNetworkMidgardClick = 'user/wallet profile | network | midgard | click',
  ...
  // Shared Wallet
  SharedWalletsGenerateClick = 'shared wallets | generate | click',
  SharedWalletsGenerateKeyClick = 'shared wallets | generate | generate key | click',
  SharedWalletsGenerateCopyKeyClick = 'shared wallets | generate | copy key | click',
  SharedWalletsGenerateCloseClick = 'shared wallets | generate | close | click',
  SharedWalletsCreateClick = 'shared wallets | create | click',
  SharedWalletsCreateWalletNameNextClick = 'shared wallets | create | wallet name | next | click',
  SharedWalletsCreateAddCosignersNextClick = 'shared wallets | create | add cosigners | next | click',
  SharedWalletsCreateImportantInfoContinueClick = 'shared wallets | create | important info | continue | click',
  SharedWalletsCreateImportantInfoBackClick = 'shared wallets | create | important info | back | click',
  SharedWalletsCreateDefineQuorumNextClick = 'shared wallets | create | define quorum | next | click',
  SharedWalletsCreateDefineQuorumDownloadClick = 'shared wallets | create | define quorum | download  | click',
  SharedWalletsCreateShareWalletDetailsOpenSharedWalletClick = 'shared wallets | create | share wallet details | open shared wallet | click',
  SharedWalletsConnectClick = 'shared wallets | connect | click',
  SharedWalletsLocateWalletImportJsonError = 'shared wallets | connect | locate wallet | import json | error',
  SharedWalletsLocateWalletOpenWalletClick = 'shared wallets | connect | locate wallet | open wallet | click',
  SharedWalletsCosignClick = 'shared wallets | co-sign  | click',
  SharedWalletsCosignTxImportJsonError = 'shared wallets | co-sign  | co-sign transaction | import json | error',
  SharedWalletsCosignTxContinueClick = 'shared wallets | co-sign  | co-sign transaction | continue | click',
  ...
  SharedWalletsSendTxConfirmationConfirmClick = 'shared wallets | send | transaction confirmation | confirm | click',
  SharedWalletsSendAllDoneView = 'shared wallets | send | all done | view',
  SharedWalletsSendAllDoneViewTxClick = 'shared wallets | send | all done | view transaction | click',
  SharedWalletsSendAllDoneCloseClick = 'shared wallets | send | all done | close | click',
  SharedWalletsSendAllDoneXClick = 'shared wallets | send | all done | x | click',
